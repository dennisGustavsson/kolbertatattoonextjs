...
const Contact = () => (
  <section id="contact" className="contact-section py-lg-5 px-lg-3 container">
    <div className="container text-center">
      ...
      <div className="contact-box border-rad-theme-2">
        ...
        <div className="socialmedia flex">
          ...
          <a
            className="facebook flex items-center gap-2"
            href="https://www.facebook.com/kolbertatattoo/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="25"
